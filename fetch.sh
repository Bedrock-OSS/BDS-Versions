...
LINUX_MANIFEST=`curl -A "Bedrock-OSS/BDS-Versions" -s ${LINUX_MANIFEST_URL} | jq`
LINUX_PREVIEW_MANIFEST=`curl -A "Bedrock-OSS/BDS-Versions" -s ${LINUX_PREVIEW_MANIFEST_URL} | jq`
WINDOWS_MANIFEST=`curl -A "Bedrock-OSS/BDS-Versions" -s ${WINDOWS_MANIFEST_URL} | jq`
WINDOWS_PREVIEW_MANIFEST=`curl -A "Bedrock-OSS/BDS-Versions" -s ${WINDOWS_PREVIEW_MANIFEST_URL} | jq`
...
wget -nc -U "Bedrock-OSS/BDS-Versions" ${LINUX_STABLE_CHANGELOG_URL} -q -O ${RELEASE_NOTES_PATH}/${LINUX_PATH}/${LINUX_STABLE_VERSION}.txt
wget -nc -U "Bedrock-OSS/BDS-Versions" ${LINUX_PREVIEW_CHANGELOG_URL} -q -O ${RELEASE_NOTES_PATH}/${LINUX_PREVIEW_PATH}/${LINUX_PREVIEW_VERSION}.txt
wget -nc -U "Bedrock-OSS/BDS-Versions" ${WINDOWS_STABLE_CHANGELOG_URL} -q -O ${RELEASE_NOTES_PATH}/${WINDOWS_PATH}/${WINDOWS_STABLE_VERSION}.txt
wget -nc -U "Bedrock-OSS/BDS-Versions" ${WINDOWS_PREVIEW_CHANGELOG_URL} -q -O ${RELEASE_NOTES_PATH}/${WINDOWS_PREVIEW_PATH}/${WINDOWS_PREVIEW_VERSION}.txt
