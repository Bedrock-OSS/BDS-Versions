...
echo "  <tr><strong>Stable</strong><td>$LINUX_STABLE_VERSION</td><td>$WINDOWS_STABLE_VERSION</td></tr>" >> README.md
echo "  <tr><strong>Preview</strong><td>$LINUX_PREVIEW_VERSION</td><td>$WINDOWS_PREVIEW_VERSION</td></tr>" >> README.md
